...
def get_gecko_data(coin):
    headers = {
        ...
        "referer": "https://www.coingecko.com/de/munze/"+coin+"/historical_data?start_date=2021-05-01&end_date=2022-06-30",
...
def get_coin_df(coin):
    ...
    df = (df
    .drop(["market_cap","total_volume"], axis=1)
    .rename(columns={"snapped_at": "date",
                     "price": coin})
    .set_index("date")
    )
